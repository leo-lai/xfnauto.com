<template>
  <view-box>
      ...
      <div class="l-flex-hc l-padding vux-1px-b">
        ...
        <div class="l-rest l-fs-m">
          ...
          <p>
            ...
            <span class="l-txt-gray l-margin-l-s">车辆数量：{{info.carNumber}}</span>
          </p>
        </div>
    ...
    <div class="l-bg-white l-zoom l-margin-t" v-if="info && info.loanType == 2">
      ...
      <div class="l-bg-white l-zoom">
        <div class="l-margin">
          ...
          <span class="l-seek-tag1 l-margin-l-s">
            <img class="_icon" src="../assets/images/icon-017.png" alt="">电话：{{info.loanPeoplePhone}}
          </span>
        </div>
