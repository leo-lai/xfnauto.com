  ...
  <view-box>
    <div class="l-user-card">
      <div v-if="userInfo" class="l-flex-hc l-padding l-margin-t">
        ...
        <div class="l-rest">
          <h4 class="l-txt-wrap1">用户昵称用户昵称用户昵称用户昵称用户昵称</h4>
          <a class="_btn1">账户资料</a>
        </div>
        <div class="_btn2">
      ...
      <div v-else class="l-padding l-margin-t-xl l-txt-center">
        <x-button :mini="true" link="/login">账号登录</x-button>
        <span class="l-margin-l"></span>
        <x-button :mini="true">注册账号</x-button>
      </div>
    </div>
...
.l-user-card{
  ...
  ._btn1{
    position: relative; background-color: #ff8a69; border-radius: 5px; padding: 3px 20px 3px 10px; font-size: 12px;
    &::after{
