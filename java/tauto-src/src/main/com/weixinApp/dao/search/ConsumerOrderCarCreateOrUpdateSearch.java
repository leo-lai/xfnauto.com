...
@Data
public class ConsumerOrderCarCreateOrUpdateSearch extends BaseSearch implements Serializable{
	
	private static final long serialVersionUID = 6884724020438232988L;
