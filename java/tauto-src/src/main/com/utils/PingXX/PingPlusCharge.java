...
public class PingPlusCharge {
    ...
    public String createCharge(String orderNo, int amount, String subject, String body, String channel, String clientIP)throws Exception{  
