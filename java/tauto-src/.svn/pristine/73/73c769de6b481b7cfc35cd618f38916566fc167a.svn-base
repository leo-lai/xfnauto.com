...
public class HttpClientUtils {
	...
	public static String doHttpGet(String url, Map params, int timeout,
			String encode) {
		String responseMsg = "";
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static String doHttpPost(String url, Map params, int timeout,
			String encode) {
		String responseMsg = "";
		HttpClient httpClient = new HttpClient();
		httpClient.getParams().setContentCharset(encode);
	 ...
	 * @return
	 */
	public static String doHttpPostXml(String url, String xmlString,
			int timeout, String encode) {
		...
		try {
			postMethod.setRequestHeader("Content-Type", "text/xml,charset="
					+ encode);
			postMethod.setRequestEntity(new StringRequestEntity(xmlString,
					"text/xml", encode));
