...
//	ResourceBundle bundle = ResourceBundle.getBundle("sysconfig");
    ...
    private static String eventPath = "webhooks_raw_post_data.json";
    private static String signPath = "signature.txt";
    ...
    public static PublicKey getPubKey() throws Exception {
        String pubKeyString = Value.Charge.pubKey;//getStringFromFile(pubKeyPath);
