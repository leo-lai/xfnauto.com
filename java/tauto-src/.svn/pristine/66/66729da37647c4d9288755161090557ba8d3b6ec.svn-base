package main.com.allInPay.dao.search;

import java.util.Date;

import main.com.frame.search.BaseSearch;

public class AllInPaySearch extends BaseSearch{
	/*千百十订单信息*/
	private Integer id;                 //主键
	private String orderCode;           //订单号
	private Integer orderId;            //订单Id
	private Float amount;               //千百十金额
	...
	private String paymentOrderId;//	通联订单号不可空	字符串，通联订单号
