...
public class StockOrderSearch extends BaseSearch{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private Boolean isSellList;
	 /**
     * 主键
     */
	...
	public Boolean getIsSellList() {
		return isSellList;
	}

	public void setIsSellList(Boolean isSellList) {
		this.isSellList = isSellList;
	}
