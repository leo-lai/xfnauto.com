...
public class ChargeExample {
    ...
    public ChargeExample() {
        this.appId = Value.Charge.appId;
        // 设置 API Key  
        Pingpp.apiKey = Value.Charge.apiKey;  
  
        // 设置私钥路径，用于请求签名  
        Pingpp.privateKeyPath = SystemPath.ROOT_PATH+File.separator+"res"+ File.separator+"rsa_private_key.pem";
    }
...
//        chargeExample.reverse(charge.getId());
    ...
    public Charge createCharge(String orderNo,String channel,int amount,String subject,String body,String clientIp) {
        Charge charge = null;
//        String channel = "";
...
//            System.out.println(chargeString);
    ...
    public Map<String, Object> channelExtra(String channel) {
